...
class PapayaModuleYoutubeVideoPage extends base_content {
  ...
  */
  ...
  /**
  * The PapayaModuleYoutubeVideo to be used
  * @var PapayaModuleYoutubeVideo
  */
  private $_pageVideoObject = NULL;

  /**
  * Set the PapayaModuleYoutubeVideo to be used
  *
  * @param PapayaModuleYoutubeVideo $pageVideoObject
  */
  ...
  *
  * @return PapayaModuleYoutubeVideo $pageBaseObject
  */
